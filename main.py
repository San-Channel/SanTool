...
__CHANNEL_USERNAME__ = "San"
__GROUP_USERNAME__   = "CP_San_chat"
...
def banner(console):
    ...
    brand_name = figlet_format('San Tool', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ SanTool[/bold green]: Car Parking Multiplayer 1 Hacking Tool.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](00) :[/cyan] [red]Exit[/red]", end="\n\n")
