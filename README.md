...
<h4>you just need an Access Key, wich you can get from <a href="https://t.me/San_Channel">@San_Channel</a> for free Credits Balance.</h4>
...
```
git clone https://github.com/San-Channel/SanTool.git
```
```
cd SanTool
```
